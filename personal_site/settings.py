...
SECRET_KEY = 'ih5887=l*7rjra9!#^jqizc_euj1l1ipzujdq_!3(p1%sul78e'
...
EMAIL_PORT = '587'
EMAIL_HOST_USER = get_env_variable('HOST_USER')
EMAIL_HOST_PASSWORD = get_env_variable('HOST_PASSWORD')
EMAIL_USE_TLS = True
